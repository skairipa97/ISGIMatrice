...
function Login({ login }) {
  ...
  return (
    <div className="min-h-screen flex flex-col bg-gray-50 dark:bg-gray-900">
      {/* Banner image - horizontal band at the top */}
      <div
        className="w-full h-160 bg-cover bg-center absolute mt-20 left-0 transform -translate-y-1/2"
        style={{ backgroundImage: "url('/banner1.png')" }}
      />
  
      <div className="absolute top-4 right-4">
        {/* Optional content, such as language switch or theme toggle */}
      </div>
  
      <div className="flex flex-col justify-center flex-1 px-6 py-12 sm:px-12 lg:px-8 mt-[230px] z-10">
  <div className="sm:mx-auto sm:w-full sm:max-w-md">
    <div className="bg-gray-50 dark:bg-gray-800 py-8 px-6 shadow rounded-lg sm:px-10">
      ...
      <footer className="bg-white/80 dark:bg-gray-800/80 backdrop-blur-sm py-4 border-t border-gray-200/50 dark:border-gray-700/50 relative z-10">
